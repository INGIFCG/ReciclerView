...
public class MainActivity extends AppCompatActivity implements ItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Item item1 = new Item(R.drawable.fruit,"Fruits","Fresh Fruit from the Garden");
        Item item2 = new Item(R.drawable.vegitables,"Vegetables","Deliciis Vegetables");
    ...
    public void onCLick(View v, int position) {
        Toast.makeText(this, "Your select: "+itemList.get(position).getItemName(),Toast.LENGTH_SHORT).show();
    }
}